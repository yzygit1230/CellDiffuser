...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--show_input', action='store_true', default=True, help='show input images with the synthesized image')
        parser.add_argument('--diffusion_path', type=str, default='checkpoints/celldeath/opt.pkl',
                            help='Path to pre-traiend.')
        parser.add_argument('--denoise_step', type=int, default=22,
        ...
        parser.add_argument('--use_scale_shift_norm', action='store_true',
                            default=False,
                            help='Whether to use scale shift norm.')
